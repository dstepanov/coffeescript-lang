...
// <netbeans>
    private CoffeeScriptLexerInput lexerInput;
    
    public void setInput(CoffeeScriptLexerInput lexerInput) {
    ...
    public TokenStream(Parser parser, CoffeeScriptLexerInput lexerInput, Reader sourceReader, String sourceString,
                int lineno) {
...
// <netbeans>
        if (lexerInput != null) {
            for(;;) {
                ...
                assert CoffeeScriptLexerInput.EOF == EOF_CHAR;
