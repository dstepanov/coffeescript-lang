...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "org.mozilla.nb.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("org/mozilla/nb/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org/mozilla/nb/javascript/BaseFunction",
                      "createObject",
        ...
        cfw.add(ByteCode.INSTANCEOF, "org/mozilla/nb/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "org/mozilla/nb/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "org/mozilla/nb/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lorg/mozilla/nb/javascript/Callable;"
                      +"Lorg/mozilla/nb/javascript/Context;"
                      +"Lorg/mozilla/nb/javascript/Scriptable;"
                      +"Lorg/mozilla/nb/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lorg/mozilla/nb/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "org/mozilla/nb/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lorg/mozilla/nb/javascript/Context;"
                      +"Lorg/mozilla/nb/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "org/mozilla/nb/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lorg/mozilla/nb/javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lorg/mozilla/nb/javascript/Context;"
                      +")Lorg/mozilla/nb/javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "org/mozilla/nb/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "org/mozilla/nb/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lorg/mozilla/nb/javascript/Context;"
                  +"Lorg/mozilla/nb/javascript/Scriptable;"
                  +"Lorg/mozilla/nb/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lorg/mozilla/nb/javascript/Scriptable;"
          +"Lorg/mozilla/nb/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lorg/mozilla/nb/javascript/NativeFunction;"
                               +"Lorg/mozilla/nb/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lorg/mozilla/nb/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lorg/mozilla/nb/javascript/NativeFunction;"
                               +"Lorg/mozilla/nb/javascript/Scriptable;"
                               +"Lorg/mozilla/nb/javascript/Scriptable;II"
                               +")Lorg/mozilla/nb/javascript/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lorg/mozilla/nb/javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "org/mozilla/nb/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lorg/mozilla/nb/javascript/Context;"
                    +")Lorg/mozilla/nb/javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lorg/mozilla/nb/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lorg/mozilla/nb/javascript/Scriptable;"
                            +"Lorg/mozilla/nb/javascript/Scriptable;"
...
*/
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "org/mozilla/nb/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "org/mozilla/nb/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "org/mozilla/nb/javascript/EcmaError";
