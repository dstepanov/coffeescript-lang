...
import static coffeescript.lang.CoffeeScriptTokenId.Category.*;

/**
 * 
 * @author Denis Stepanov
 */
public enum CoffeeScriptTokenId {
    ...
    private CoffeeScriptTokenId(String fixedText, Category category) {
